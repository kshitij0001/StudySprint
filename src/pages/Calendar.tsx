...
export default function Calendar() {
  ...
  // Mock events data - would come from SRS store in real implementation
  const mockEvents = [
    { date: new Date(), type: 'review', subject: 'Physics', title: 'Newton\'s Laws Review' },
    { date: new Date(Date.now() + 86400000), type: 'study', subject: 'Chemistry', title: 'Organic Chemistry' },
    { date: new Date(Date.now() + 2 * 86400000), type: 'test', subject: 'Biology', title: 'Mock Test' },
  ];
